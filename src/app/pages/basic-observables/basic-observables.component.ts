...
export class BasicObservablesComponent {
  pageData = {
    ...
    En esta sección, exploraremos diferentes formas de crear y trabajar con Observables básicos, desde temporizadores simples hasta la creación
    de Observables personalizados.`,
    commonUses: [
...
custom$.subscribe({
  ...
  complete: () => console.log('✅ ¡Observable completado!')
      ...
      },
      {
        ...
        description:
          'Simulación de eventos de input con transformación de datos',
...
search$.subscribe({
  ...
  complete: () => console.log('✅ ¡Búsqueda completada!')
    ...
    marbleDiagram:
      'https://rxjs.dev/assets/images/guide/observable-overview.png',
  };
}
